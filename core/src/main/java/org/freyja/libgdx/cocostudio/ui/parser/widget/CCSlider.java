...
public class CCSlider extends GroupParser {
    ...
    public Actor parse(CocoStudioUIEditor editor, ObjectData widget) {
        ...
        SliderStyle style = new SliderStyle(editor.findDrawable(widget, widget.getBackGroundData()), editor.findDrawable(widget, widget.getBallNormalData()));

        style.knob = editor.findDrawable(widget, widget.getProgressBarData());
        style.disabledBackground = editor.findDrawable(widget, widget.getBallDisabledData());
