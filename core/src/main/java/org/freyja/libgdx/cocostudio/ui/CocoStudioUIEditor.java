...
//	Map<String, Map<Actor, Action>> animations;
     ...
     */
    public CocoStudioUIEditor(FileHandle jsonFile, Map<String, FileHandle> ttfs, Map<String, BitmapFont> bitmapFonts, FileHandle defaultFont, Collection<TextureAtlas> textureAtlas) {
...
//		animations = new HashMap<String, Map<Actor, Action>>();
    ...
    public CocoStudioUIEditor(Map<String, FileHandle> ttfs, Map<String, BitmapFont> bitmapFonts, FileHandle defaultFont, Collection<TextureAtlas> textureAtlas) {
        this.textureAtlas = textureAtlas;
        this.ttfs = ttfs;
        this.bitmapFonts = bitmapFonts;
        this.defaultFont = defaultFont;
...
//	}
    ...
    // }
    //
    // animations.put(action.getUserName(), actions);
    // }
    //
    // }
