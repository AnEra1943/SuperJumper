...
public class ScrollViewObjectData extends GroupData {
	public net.mwplay.cocostudio.ui.model.FileData FileData;
    public String ScrollDirectionType;
    public boolean ClipAble;
    public boolean IsBounceEnabled;
    public net.mwplay.cocostudio.ui.model.InnerNodeSize InnerNodeSize;
    public int ComboBoxIndex;
    public net.mwplay.cocostudio.ui.model.CColor SingleColor;
